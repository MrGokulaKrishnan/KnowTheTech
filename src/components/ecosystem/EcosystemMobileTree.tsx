...
export const EcosystemMobileTree: React.FC = () => {
  return (
    <div className="md:hidden space-y-6">
      {/* Root Node */}
      <GlassCard className="p-6 text-center border-sky-400/40 bg-gradient-to-b from-[#0B2A4A]/40 to-[#000000]/90 shadow-glow-electric">
        ...
        <p className="text-xs text-slate-300 mt-1">
          One ecosystem. Eight products. Built with technology.
        </p>
      </GlassCard>

      {/* Connected Branches 01 to 08 */}
            ...
            <div className="flex items-start justify-between gap-3 mb-2">
              <div>
                <div className="flex items-center gap-2">
                  <span className="product-number-badge px-1.5 py-0.5 rounded text-[10px] font-semibold">
                    {product.number} / 08
                  </span>
